namespace Robot.ObjectRecognition.Parser
{
    using System;
    ...
    public class YoloOutputParser
    {
        ...
        public IReadOnlyList<YoloBoundingBox> ParseOutputs(float[] yoloModelOutputs, float threshold = .3F)
        {
        ...
        {
            // YOLO outputs a tensor that has a shape of 125x13x13, which WinML flattens into a 1D
            // array. To access a specific channel for a given (x,y) cell position, we need to
            // calculate an offset into the array
